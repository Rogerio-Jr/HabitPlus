...
enum WebService {
  ...
  static func postUser(request: SingUpRequest, completion: @escaping (Bool?, ErroResponse?) -> Void) {
  ...
  static func login(request: SingInRequest, completion: @escaping (SingInResponse?, SignErrorResponse?) -> Void) {
